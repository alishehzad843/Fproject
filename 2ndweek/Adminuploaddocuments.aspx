<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" UnobtrusiveValidationMode="none" AutoEventWireup="true" CodeFile="Adminuploaddocuments.aspx.cs" Inherits="Adminuploaddocuments" %>
            ...
            <div class="col-lg-10" style="padding:10px; border:groove;background-color:ghostwhite; margin-top:50px; font-family:Cambria;">
                ...
                <div class="form-group">
                    ...
                    <div class="row" style=" font-style:italic;">
                        ...
                        <div class="col-lg-2">
                             <center><asp:Button runat="server" ID="submit" CssClass="btn btn-dark"  Text="ADD" /></center>
                        </div>
                         <div class="col-lg-5"></div>
                       </div>
                       </div>
